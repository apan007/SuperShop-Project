...
public class SalesReturn extends JPanel{
	...
	JTextField txtAlreadyReceive=new JTextField(10);
	...
	String col[]={"SalesNo","ProductID","ProductName","Unit","SalesQty","AlreadyReturn","ReceiveQty",
			"TradePrice","Remarks","Amount"};
	Object row[][];
	...
	String col1[]={"SalesReturn No","Total Amount","Date"};
	Object row1[][];
	...
	private void panelWestCenterwork() {
		...
		panelWestCenter.add(lblSalesNo,c);
		
		c.gridx=1;
		c.gridy=0;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelWestCenter.add(cmbSalesNo,c);
		...
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelWestCenter.add(lblAlreadyReceive,c);
		
		c.gridx=3;
		c.gridy=1;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelWestCenter.add(txtAlreadyReceive,c);
		...
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelWestCenter.add(lblReceiveQty,c);
	...
	private void panelNorthWestwork() {
		...
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelNorthWest.add(lblSalesReturnNo,c);
		
		c.gridx=1;
		c.gridy=0;
		c.fill=GridBagConstraints.BOTH;
		c.insets=new Insets(5,5,5,5);
		panelNorthWest.add(txtSalesReturnNo,c);
	...
	private void panelCenterCenterwork() {
		...
		scroll1.setPreferredSize(new Dimension(535,350));
	}
	...
	private void panelSouthCenterwork() {
		...
		scroll.setPreferredSize(new Dimension(1100,160));
